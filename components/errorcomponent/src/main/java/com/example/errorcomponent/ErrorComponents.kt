...
@Preview
fun ErrorWithRetry() {
    ErrorWithRetry(text = com.example.strings.R.string.no_developer_loaded_no_connect)
}
...
fun RetryOption(onRetryClicked: () -> Unit = {}) {
    Column(modifier = Modifier
        ...
        Icon(
            ...
            contentDescription = stringResource(id = com.example.strings.R.string.retry),
            modifier = Modifier
                .size(50.dp)
        )
